...
export function MobileNav({ isOpen, onClose }: MobileNavProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 lg:hidden">
      ...
      {/* Drawer */}
      <div className="fixed inset-y-0 right-0 w-full max-w-sm bg-white dark:bg-slate-900 p-6 shadow-2xl flex flex-col justify-between overflow-y-auto animate-in slide-in-from-right duration-200 border-l border-slate-200/80 dark:border-slate-800">
        <div>
          {/* Header */}
          <div className="flex items-center justify-between pb-6 border-b border-slate-100 dark:border-slate-800">
            ...
            >
              ...
              <span>Freelance<span className="text-brand-600 dark:text-brand-400">Hub</span></span>
            </Link>
            <button
              onClick={onClose}
          ...
          <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/70 border border-slate-100 dark:border-slate-800 my-2">
            <span className="inline-block text-[11px] font-semibold text-brand-700 dark:text-brand-300 bg-brand-100/60 dark:bg-brand-900/40 px-2 py-0.5 rounded-full mb-1">
              Zero Risk Escrow
            </span>
