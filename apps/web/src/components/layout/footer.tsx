...
export function Footer() {
  ...
  return (
    <footer className="bg-white dark:bg-slate-950 text-slate-600 dark:text-slate-300 border-t border-slate-200 dark:border-slate-800/80 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 lg:col-span-2 space-y-4">
            <Link
              href="/"
              className="flex items-center gap-2.5 font-bold text-xl text-slate-900 dark:text-white tracking-tight"
            >
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-slate-500 dark:text-slate-400">
              ...
              <li>
                <Link href="#freelancers" className="hover:text-slate-900 dark:hover:text-white transition-colors">
                  Explore Talent
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/client/jobs/new" className="hover:text-slate-900 dark:hover:text-white transition-colors">
                  Post a Project
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-slate-500 dark:text-slate-400">
              ...
              <li>
                <Link href="#testimonials" className="hover:text-slate-900 dark:hover:text-white transition-colors">
                  Success Stories
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-slate-500 dark:text-slate-400">
              ...
              <li>
                <span className="text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white cursor-pointer transition-colors">
                  Privacy Policy
                </span>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 dark:text-slate-500">
          ...
          <div className="flex items-center gap-5 text-slate-400 dark:text-slate-400">
            <a
            ...
            <span className="hover:text-slate-900 dark:hover:text-white cursor-pointer transition-colors" aria-label="Twitter">
              <Twitter className="h-4 w-4" />
            </span>
            <span className="hover:text-slate-900 dark:hover:text-white cursor-pointer transition-colors" aria-label="LinkedIn">
