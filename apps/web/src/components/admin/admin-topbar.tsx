...
import { Menu, Activity, ShieldCheck, Camera } from "lucide-react";
        ...
        <div className="flex items-center gap-3">
          ...
          {user && (
            <button
              ...
              className="relative p-0.5 rounded-full hover:ring-2 hover:ring-brand-500/50 transition-all"
              title="Change admin photo"
              aria-label="Admin profile photo"
            >
              <Avatar
                src={user.avatarUrl}
