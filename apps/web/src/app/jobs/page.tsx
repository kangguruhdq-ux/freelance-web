    ...
    <div className="min-h-screen bg-slate-50/50 py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Explore High-Impact Projects</h1>
        ...
        {/* Search & Filter Bar */}
        <Card className="p-4 sm:p-5 shadow-card bg-white border-slate-200">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
            ...
            <div className="md:col-span-3">
              <select
                className="w-full h-11 px-3 rounded-lg border border-slate-200 bg-white text-sm font-medium text-slate-700 focus:outline-none focus:ring-2 focus:ring-brand-500"
        ...
        <div className="space-y-4">
          {loading ? (
            ...
            jobs.map((job) => (
              <Card
                key={job.id}
                className="p-6 transition-all duration-200 hover:shadow-card-hover border-slate-200 bg-white group"
              >
