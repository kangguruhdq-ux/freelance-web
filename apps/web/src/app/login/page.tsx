...
function LoginForm() {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center px-4 py-12 bg-slate-50/50 dark:bg-slate-950 transition-colors">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="bg-white dark:bg-slate-900 p-7 sm:p-8 rounded-2xl border border-slate-200/90 dark:border-slate-800 shadow-card">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-brand-600 dark:text-brand-400 hover:underline cursor-pointer font-medium">
                  Forgot password?
                </span>
              </div>
              <div className="relative">
                <Input
                  ...
                  className="h-11 pr-10 dark:bg-slate-800 dark:border-slate-700"
                />
                <button
                  type="button"
          ...
          <div className="mt-6 pt-5 border-t border-slate-100 dark:border-slate-800">
            <p className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400 mb-2.5 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
              <button
                ...
                className="px-2.5 py-2 rounded-lg bg-slate-50 dark:bg-slate-800/60 hover:bg-slate-100 dark:hover:bg-slate-800 border border-slate-200/80 dark:border-slate-700 text-left transition-colors"
              >
            ...
            <p className="text-[11px] text-slate-400 text-center mt-2">
              ...
              <code className="text-slate-600 dark:text-slate-300 font-mono">FreelanceHub2026!</code>
            </p>
          </div>
        </div>
